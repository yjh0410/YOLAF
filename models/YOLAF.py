...
class YOLAF(nn.Module):
    def __init__(self, device, input_size=None, trainable=False, conf_thresh=0.01, nms_thresh=0.3, anchor_size=None, hr=False):
        ...
        # backbone darknet-19 (optional: darknet-19)
        ...
        self.pred_3 = nn.Conv2d(1024, self.anchor_number*(1 + 4), 1)
        ...
        self.pred_2 = nn.Conv2d(512, self.anchor_number*(1 + 4), 1)
        ...
        self.pred_1 = nn.Conv2d(256, self.anchor_number*(1 + 4), 1)
